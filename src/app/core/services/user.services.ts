...
export class UserService {
  ...
  // 🏆 Consulta analítica: Top Ciudadanos por puntos
  getTopCitizensByPoints(): Observable<any[]> {
    return this.http.get<any[]>(`${this.url}/top-participacion`);
  }
  // 🚀 Llamamos al nuevo endpoint de Java
  getUserByEmail(email: string): Observable<any> {
    return this.http.get<any>(`${this.url}/buscar-email/${email}`);
  }
}
